...
export default function CreateReview(props) {
    ...
    return (
        <div>
            ...
            <Rating name="rating-review" button="true" value={rating} onChange={(rtg) => setRating(rtg)} className={classes.rating} />
            <TextareaAutosize disabled={!isLoggedIn} value={review} onChange={(e) => setReview(e.target.value)} maxLength={300} className={classes.reviewBox} boxshadow={3} minRows={6} placeholder={isLoggedIn ? "Write Your Review Here ..." : "Please Log In to Write Your Review Here ..."} />
